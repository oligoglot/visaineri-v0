...
@
text
@/* Generated By:JavaCC: Do not edit this line. KuralTokenManager.java */

public class KuralTokenManager implements KuralConstants
{
...
public KuralTokenManager(SimpleCharStream stream)
{
   if (input_stream != null)
      throw new TokenMgrError("ERROR: Second call to constructor of static lexer. You must use ReInit() to initialize the static variables.", TokenMgrError.STATIC_LEXER_ERROR);
   input_stream = stream;
}
public KuralTokenManager(SimpleCharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
